/*
  ...
  - Added the required column `richDescription` to the `Product` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "richDescription" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "ShippingAddress" ADD CONSTRAINT "ShippingAddress_userId_fkey" FOREIGN KEY ("userId") REFERENCES "UserSettings"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
